...
class Userbot(Client):
    ...
    async def start(self):
        ...
        if config.STRING2:
            ...
            try:
                await self.two.join_chat("VRINNDAVAN_NAGRI")
                
                await self.one.join_chat("PENGUIN_LOGS")
            except:
                pass
            assistants.append(2)
            try:
        ...
        if config.STRING3:
            ...
            try:
                await self.three.join_chat("VRINNDAVAN_NAGRI")
        ...
        if config.STRING4:
            ...
            try:
                await self.four.join_chat("VRINNDAVAN_NAGRI")
        ...
        if config.STRING5:
            ...
            try:
                await self.five.join_chat("VRINNDAVAN_NAGRI")
